...
// TODO(necula): this is used only by JAX < 0.4.13
...
py::dict Registrations() {
  pybind11::dict dict;
  // TODO(necula): this must be kept for backwards compatibility with JAX
  // versions < 0.4.13.
...
PYBIND11_MODULE(_ducc_fft, m) {
  ...
  // TODO(necula): this can be removed, it is used only by JAX < 0.4.13.
