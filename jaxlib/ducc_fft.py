...
# TODO(necula): this can be removed eventually, only used with JAX < 0.4.13
...
# TODO(necula): this can be removed, used only with JAX < 0.4.13
...
def dynamic_ducc_fft_hlo(
  ...
  return custom_call(
      "dynamic_ducc_fft",
      [result_type],
      [descriptor, a, shape, strides_in, strides_out, scale],
